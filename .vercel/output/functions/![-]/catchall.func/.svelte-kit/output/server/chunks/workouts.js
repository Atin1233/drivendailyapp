const workouts = [
  ...
  },
  {
    ...
    description: "Functional movement patterns that translate to real-world strength and mobility.",
    category: "strength",
  ...
  },
  {
    ...
    description: "Moderate-intensity cardio session to build endurance and improve cardiovascular health.",
    category: "cardio",
    difficulty: "beginner",
    split: "cardio-focused",
    duration: 45,
  ...
  },
  {
    ...
    description: "Comprehensive stretching routine to improve mobility and reduce muscle tension.",
  ...
  // Additional Strength Training Workouts
  {
    ...
    description: "Foundation powerlifting program focusing on the big three lifts: squat, bench, and deadlift.",
    category: "strength",
    difficulty: "intermediate",
    split: "powerlifting",
    duration: 90,
  ...
  },
  {
    ...
    description: "Classic bodybuilding upper body workout focusing on muscle hypertrophy and definition.",
    category: "strength",
    difficulty: "intermediate",
    split: "bodybuilding",
    duration: 75,
  ...
  },
  {
    ...
    description: "Arnold Schwarzenegger's legendary chest and back superset workout for maximum muscle growth.",
    category: "strength",
    difficulty: "advanced",
    split: "arnold-split",
    duration: 90,
  ...
  },
  {
    ...
    description: "Arnold's shoulder and arm superset workout for building massive deltoids and arms.",
    category: "strength",
    difficulty: "advanced",
    split: "arnold-split",
    duration: 75,
  ...
  },
  {
    ...
    description: "Arnold's legendary leg day workout for building tree trunk thighs and powerful legs.",
    category: "strength",
    difficulty: "advanced",
    split: "arnold-split",
    duration: 90,
  ...
  },
  {
    ...
    description: "Real-world strength training focusing on movements that translate to daily activities.",
    category: "strength",
    difficulty: "intermediate",
    split: "functional",
    duration: 60,
  ...
  },
  {
    ...
    description: "Build both strength and endurance with this hybrid workout combining heavy lifts and conditioning.",
    category: "strength",
    difficulty: "intermediate",
    split: "functional",
    duration: 70,
  ...
  // Additional Cardio Workouts
  {
    ...
    description: "High-intensity interval running workout to improve speed and cardiovascular fitness.",
    category: "cardio",
    difficulty: "intermediate",
    split: "cardio-focused",
    duration: 40,
  ...
  },
  {
    ...
    description: "High-energy indoor cycling workout with varying resistance and cadence.",
    category: "cardio",
    difficulty: "intermediate",
    split: "cardio-focused",
    duration: 45,
  ...
  },
  {
    id: "rowing-cardio",
    title: "Rowing Cardio",
    description: "Full-body cardio workout using rowing machine for strength and endurance.",
    category: "cardio",
    difficulty: "intermediate",
    split: "cardio-focused",
    duration: 35,
  ...
  },
  {
    ...
    description: "Low-impact elliptical workout perfect for recovery days or joint-friendly cardio.",
    category: "cardio",
    difficulty: "beginner",
    split: "cardio-focused",
    duration: 30,
  ...
  // Additional HIIT Workouts
  {
    id: "tabata-hiit",
    title: "Tabata HIIT",
    description: "Classic Tabata protocol: 20 seconds work, 10 seconds rest for 8 rounds per exercise.",
    category: "hiit",
    difficulty: "advanced",
    split: "cardio-focused",
    duration: 25,
  ...
  },
  {
    id: "amrap-hiit",
    title: "AMRAP HIIT",
    description: "As Many Rounds As Possible in 20 minutes of high-intensity exercises.",
    category: "hiit",
    difficulty: "intermediate",
    split: "cardio-focused",
    duration: 25,
  ...
  },
  {
    id: "emom-hiit",
    title: "EMOM HIIT",
    description: "Every Minute On the Minute workout with alternating exercises for maximum intensity.",
    category: "hiit",
    difficulty: "advanced",
    split: "cardio-focused",
    duration: 20,
  ...
  },
  {
    id: "circuit-hiit",
    title: "Circuit HIIT",
    description: "High-intensity circuit training with minimal rest between exercises.",
    category: "hiit",
    difficulty: "intermediate",
    split: "cardio-focused",
    duration: 35,
  ...
  // Additional Yoga Workouts
  {
    id: "power-yoga",
    title: "Power Yoga",
    description: "Dynamic, fitness-based approach to vinyasa-style yoga for strength and flexibility.",
    category: "yoga",
    difficulty: "intermediate",
    split: "functional",
    duration: 60,
  ...
  },
  {
    id: "yin-yoga",
    title: "Yin Yoga",
    description: "Slow-paced style of yoga with postures held for longer periods to target deep connective tissues.",
    category: "yoga",
    difficulty: "beginner",
    split: "functional",
    duration: 45,
  ...
  },
  {
    ...
    description: "Gentle, therapeutic style of yoga that uses props to support the body in passive poses.",
    category: "yoga",
    difficulty: "beginner",
    split: "functional",
    duration: 40,
  ...
  },
  {
    ...
    description: "Energizing morning yoga sequence to wake up the body and mind.",
    category: "yoga",
    difficulty: "beginner",
    split: "functional",
    duration: 25,
  ...
  // Additional Flexibility Workouts
  {
    ...
    description: "Active stretching routine to warm up muscles and improve range of motion.",
    category: "flexibility",
    difficulty: "beginner",
    split: "functional",
    duration: 20,
  ...
  },
  {
    ...
    description: "Comprehensive cool-down stretching routine to aid recovery and reduce muscle soreness.",
    category: "flexibility",
    difficulty: "beginner",
    split: "functional",
    duration: 25,
  ...
  },
  {
    ...
    description: "Intensive stretching session for improving flexibility and releasing deep muscle tension.",
    category: "flexibility",
    difficulty: "intermediate",
    split: "functional",
    duration: 40,
  ...
  },
  {
    ...
    description: "Self-myofascial release using foam roller to break up muscle knots and improve mobility.",
    category: "flexibility",
    difficulty: "beginner",
    split: "functional",
    duration: 20,
  ...
  // Additional Specialized Workouts
  {
    id: "core-focused",
    title: "Core Focused",
    description: "Comprehensive core workout targeting all areas of the abdominal muscles and lower back.",
    category: "strength",
    difficulty: "intermediate",
    split: "functional",
    duration: 30,
  ...
  },
  {
    ...
    description: "Bodyweight training fundamentals focusing on building strength without equipment.",
    category: "strength",
    difficulty: "beginner",
    split: "functional",
    duration: 45,
  ...
  },
  {
    ...
    description: "Advanced bodyweight training with complex movements and progressions.",
    category: "strength",
    difficulty: "advanced",
    split: "functional",
    duration: 60,
  ...
  },
  {
    ...
    description: "Light, low-intensity workout perfect for active recovery days.",
    category: "flexibility",
    difficulty: "beginner",
    split: "functional",
    duration: 30,
