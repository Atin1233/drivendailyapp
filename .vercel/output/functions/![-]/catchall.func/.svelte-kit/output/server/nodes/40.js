import stylesheet_40 from '../stylesheets/40.js';

export const index = 40;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(marketing)/workouts/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/40.D-W_Ze-D.css"];
export const fonts = [];
export const inline_styles = () => ({
	"_app/immutable/assets/40.D-W_Ze-D.css": stylesheet_40
});
