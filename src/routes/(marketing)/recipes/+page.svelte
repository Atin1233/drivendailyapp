<script lang="ts">
  ...
  const recipes: Recipe[] = [
    ...
    },
    {
      ...
      description:
        "A comforting, creamy risotto that's surprisingly healthy and satisfying.",
      category: "vegetarian",
      difficulty: "medium",
      meal: "dinner",
      prepTime: 10,
      ...
      tags: ["comfort-food", "date-night", "elegant"],
    },
    ...
    // More Vegan Recipes
    {
      ...
      description:
        "A make-ahead breakfast that's creamy, nutritious, and delicious.",
      category: "vegan",
      difficulty: "easy",
      meal: "breakfast",
      prepTime: 5,
      ...
      tags: ["meal-prep", "fiber-rich", "quick"],
    },
    {
      id: "vegan-cauliflower-steak",
      title: "Roasted Cauliflower Steak",
      description:
        "A hearty, meaty cauliflower steak that's perfect for a plant-based dinner.",
      category: "vegan",
      difficulty: "medium",
      meal: "dinner",
      prepTime: 10,
      ...
      tags: ["gluten-free", "low-carb", "elegant"],
    },
    ...
    // More Vegetarian Recipes
    {
      ...
      description:
        "A protein-rich pasta dish that's creamy and satisfying without heavy cream.",
      category: "vegetarian",
      difficulty: "easy",
      meal: "dinner",
      prepTime: 10,
      ...
      instructions: [
        ...
        "Add pasta and spinach, toss to combine",
      ],
